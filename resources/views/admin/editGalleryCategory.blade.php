...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>ویرایش دسته بندی های گالری</h2>
                        ...
                        <form id="editForm">
                            ...
                            <tr class="unit">
                                ...
                                @if($unitCount[0]->active == 0)
                                    <td><a id="active" content="{{$unitCount[0]->active}}" name="{{$unitCount[0]->id}}" type="button"  data-content="فعال" class="btn btn-success">فعال کردن</a></td>
                                @endif
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            ...
                            ({
                                cache: false,
                                url: "{{url('admin/editGalleryCategoryTitle')}}",
        ...
        <script>
            $(document).on('click','#active',function () {
                ...
                //alert(title);
                swal({
                        title:   " آیا در نظر دارید وضعیت دسته بندی گالری را " +"(( "+ title +" ))"+  "  نمایید؟ ",
                        text: "",
                        type: "info",
                        showCancelButton: true,
                        confirmButtonColor: "	#5cb85c",
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            ...
                            ({
                                cache: false,
                                url: "{{url('admin/enableOrDisableGalleryCategory')}}",
                                type: "post",
