    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <a href="{{url('admin/addGallery')}}" id="user-send" type="button" class="col-md-2 col-md-offset-5 btn btn-info" style=" font-weight: bold;">
                    <i class="fa fa-th-list"></i>                    افزودن تصویر گالری                </a>
                    ...
                    <table style="direction:rtl;text-align: center" id="example"
                        ...
                        @foreach($gallery as $slider)
                            <tr class="unit">
                                ...
                                @endif
                                <td><strong><a class="btn btn-warning col-md-8 col-md-offset-2"   href="{{url('admin/editGallery/'.$slider->id)}}">ویرایش</a></strong> </td>
        ...
        <script>
            $(document).on('click','#showPicture',function(){
                ...
                $('#image').attr("src","{{url('public/dashboard/Gallery')}}"+'/'+src);
                $('#myModal').modal('show');
            })
        </script>
@endsection
