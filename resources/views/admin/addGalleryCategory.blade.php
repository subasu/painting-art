...
@section('content')
    ...
    <div class="row">
        <div class="col-md-10 col-sm-6 col-xs-12 col-md-offset-1">
            <div class="x_panel">
                <div class="x_title">
                    <h2> فرم ایجاد دسته بندی های گالری</h2>
                        ...
                        <form  class="form-horizontal form-label-left" id="unitForm"  method="POST" style="direction: rtl !important;">
                            ...
                            <div class="item form-group">
                                <div id="showUnits" style="display: none; !important;">
                                    ...
                                    <label class="control-label col-md-3 col-sm-4 col-xs-3" for="title"> دسته بندی های موجود : <span
                                                class="star" title="پر کردن این فیلد الزامی است"></span>
                                    </label>
                                    <label id="existedSub" style="display: none; margin-top: 3%;" class="control-label col-md-3 col-sm-4 col-xs-3" for="title"> دسته بندی های موجود : <span
                                                class="star" title="پر کردن این فیلد الزامی است"></span>
                                    </label>
                            ...
                            <div class="form-group">
                                <div class="col-md-12" style="margin-top: 2%;">
                                    ...
                                    <button id="addMainUnit" type="button" class="col-md-9 btn btn-success" style="display: none;">اضافه کردن دسته بندی های جدید</button>
            ...
            (
                ...
                "<br/><br/>"+
                    ...
                    "<div class='col-md-9 col-sm-9 col-xs-9'>"+
                        "<input id='unit' class='form-control col-md-12 col-xs-12 required' name='category[]' placeholder='' required='required' type='text'>"+
                    "</div>"+
                    ...
                    $.each(response, function (key, value) {
                        ...
                        if(value.active == 1)
                        {
                            ...
                            (
                                ...
                                option += "<option selected='true' disabled='disabled' id='"+value.id+"'>"+value.title+"</option>"
                            );
                        }
                        if(value.active == 0)
                        {
                            ...
                            (
                                ...
                                option += "<option selected='true' disabled='disabled' style='background-color: lightgray;' id='"+value.id+"'>"+value.title+"</option>"
                            );
                        }
                    });
    ...
    <script>
        $(document).on('click','#reg',function(){
            ...
            ({
                cache       : false,
                url         : "{{url('admin/addNewGalleryCategory')}}",
                type        : "post",
                processData : false,
                contentType : false,
                dataType    : "json",
